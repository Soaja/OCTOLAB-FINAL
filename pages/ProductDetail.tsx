...
// ============================================
// NEW: Product Schema Component for Google
// ============================================
...
export const ProductDetail: React.FC<ProductDetailProps> = ({ onAddToCart }) => {
  ...
  // ============================================
  // ENHANCED SEO: Dynamic per product
  // ============================================
  const pageTitle = product 
    ? `${product.name} Peptid Srbija | Kupite ${product.name} (${product.dosage}) | OCTOLAB` 
    : 'Učitavanje... | OCTOLAB';
  
  const pageDesc = product 
    ? `Kupite ${product.name} (${product.subtitle}) u Srbiji. ${product.description.slice(0, 120)}... Čistoća >99%, HPLC sertifikat, hladni lanac dostava. OCTOLAB Precision Research.` 
    : 'Detalji proizvoda...';

  const canonicalUrl = product 
    ? `https://www.octolab.rs/${product.slug}` 
    : undefined;
        ...
        <div className="max-w-[1400px] mx-auto px-6 pb-24">
            ...
            <div className="lg:col-span-5 relative lg:sticky lg:top-32">
                ...
                >
                    ...
                    <motion.img 
                    src={product.image} 
                    alt={`${product.name} peptid - ${product.subtitle} - OCTOLAB Srbija`}
                    animate={{ y: [0, -10, 0] }}
                ...
                <div className="mt-16 pt-8 border-t border-neutral-100">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        {relatedProducts.map((item) => (
                            ...
                            >
                                <img src={item.image} alt={`${item.name} peptid OCTOLAB`} className="w-12 h-12 mx-auto mb-2 object-contain mix-blend-multiply" />
